...
#### Option A: Using MySQL/PostgreSQL (o MySQL cPanel – Cepromed)

Update your `.env` file with your database credentials. Para **Cepromed** con base de datos en cPanel, usa:
...
(La contraseña se configura solo en `.env`; no se sube al repositorio. Ver `docs/MIGRACION_CEPROMED.md` para el plan de migración.)
