                        ...
                        <div>
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="info@gmail.com" autocomplete="email" required
                                    ...
                                    <div>
                                        ...
                                        <div x-data="{ showPassword: false }" class="relative">
                                            <input :type="showPassword ? 'text' : 'password'" id="password" name="password" placeholder="Contraseña" autocomplete="current-password" required
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div x-data="{ checkboxToggle: {{ old('remember') ? 'true' : 'false' }} }">
                                            <label for="remember"
                                                ...
                                                <div class="relative">
                                                    <input type="checkbox" id="remember" name="remember" value="1" class="sr-only" @change="checkboxToggle = !checkboxToggle" {{ old('remember') ? 'checked' : '' }} />
                            ...
                            <div class="mt-5">
                                <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                    ¿No tienes cuenta?
                                    <a href="{{ route('signup') }}" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Registrarse</a>
                                </p>
                            </div>
                        </div>
                    </div>
