                    ...
                    <div>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Tu nombre" autocomplete="name" required
                                ...
                                <div>
                                    ...
                                    <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="correo@ejemplo.com" autocomplete="email" required
                                ...
                                <div>
                                    ...
                                    <div x-data="{ showPassword: false }" class="relative">
                                        <input :type="showPassword ? 'text' : 'password'" id="password" name="password" placeholder="Contraseña" autocomplete="new-password" required
                                ...
                                <div>
                                    ...
                                    <input type="password" id="password_confirmation" name="password_confirmation" placeholder="Repetir contraseña" autocomplete="new-password" required
                                    ...
                                    <div x-data="{ checkboxToggle: false }">
                                        <label for="checkboxLabelOne"
                                            ...
                                            <p class="inline-block font-normal text-gray-500 dark:text-gray-400">
                                                ...
                                                <span class="text-gray-800 dark:text-white/90">términos y condiciones</span>
                                                y la
                        ...
                        <div class="mt-5">
                            <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                ¿Ya tienes cuenta?
                                <a href="{{ route('signin') }}" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Iniciar sesión</a>
                            </p>
                        </div>
                    </div>
                </div>
