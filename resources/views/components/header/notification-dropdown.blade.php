{{-- Notification Dropdown Component (vacío por ahora) --}}
<div class="relative" x-data="{
    ...
    >
        ...
        <!-- Notification List (vacío por ahora) -->
        <div class="flex flex-1 flex-col items-center justify-center py-12 text-center">
            <p class="text-gray-500 dark:text-gray-400 text-sm">No hay notificaciones.</p>
        </div>
    </div>
    <!-- Dropdown End -->
</div>
